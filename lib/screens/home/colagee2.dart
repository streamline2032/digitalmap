...
class MyCollagee2Page extends StatefulWidget {
  MyCollagee2Page({ Key? key,  required this.title}) : super(key: key);

  final String title;


  @override
  _MyCollagee2PageState createState() => _MyCollagee2PageState();
}

class _MyCollagee2PageState extends State<MyCollagee2Page>with WidgetsBindingObserver {
      ...
      /*    clipBehavior: Clip.antiAliasWithSaveLayer,
        ...
        //  SizedBox(height: 100,),
          ...
          onTap:() async {
            ...
            await appState.getListCollageW(id ,icontitle);
              ...
              GridView.count(
                ...
                //  for(int i= 0; i<= (appState.responseBodyCatog.length -1); i++)
                 //   singleCard(appState.responseBodyCatog[i]['name'],appState.responseBodyCatog[i]['id']),
                  ...
                  singleCard("كلية التصميم والفنون",14, 17.0),
