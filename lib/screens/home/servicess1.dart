...
class MyServicess1Page extends StatefulWidget {
  MyServicess1Page({ Key? key,  required this.title}) : super(key: key);

  final String title;


  @override
  _MyServicess1PageState createState() => _MyServicess1PageState();
}

class _MyServicess1PageState extends State<MyServicess1Page>with WidgetsBindingObserver {
      ...
      /*    clipBehavior: Clip.antiAliasWithSaveLayer,
        ...
        //  SizedBox(height: 100,),
          ...
          onTap:() async {
            ...
            await appState.getServicessM(id ,icontitle);
            ...
            */
            ...
            appBar: AppBar(
             ...
             // backgroundColor: ColorsConsts.a2,
              ...
              //Center(child:
              Text("خدمات الكليات", style: TextStyle( fontFamily: 'ElMessiri' ,// fontWeight: FontWeight.bold
    ),),),
            //),
            body:
