      ...
      /*    clipBehavior: Clip.antiAliasWithSaveLayer,
        ...
        child: GestureDetector(
          ...
          padding: EdgeInsets.all(0.0),
            decoration: BoxDecoration(
              //border: Border.all(color: ColorsConsts.a1)
        ...
        //  SizedBox(height: 100,),
          ...
          onTap:() async {
            ...
            if(id == 0) {
              changeScreen(context, MyServicessPage(title: 'Servicess',));
            }else if (id == 1){
              changeScreen(context, MyCollageePage(title: 'colagge',));
            }else {
              await appState.getListProduct(id, icontitle);
            ...
            */
            ...
            /*  leading: IconButton(
             ...
             // backgroundColor: ColorsConsts.a2,
              ...
              //Center(child:
              Text("الخريطة الرقمية لجامعة طيبة", style: TextStyle( fontFamily: 'ElMessiri',// fontWeight: FontWeight.bold
    ),),),
            //),
            body:
              ...
              GridView.count(
                ...
                //  for(int i= 0; i<= (appState.responseBodyCatog.length -1); i++)
                 //   singleCard(appState.responseBodyCatog[i]['name'],appState.responseBodyCatog[i]['id']),
                  ...
                  singleCard("الخدمات ",0, 17.0),
                  singleCard("الكليات والأقسام",1, 17.0),
                  singleCard("المعاهد",2, 17.0),
                  singleCard("المراكز",3, 17.0),
                  singleCard("العمادات",4, 17.0),
                  singleCard("الوكالات ",5, 16.0),
                  singleCard("اللجان",6, 17.0),
                  singleCard("الإدارات",7, 17.0),
