...
class MyServicess2Page extends StatefulWidget {
  MyServicess2Page({ Key? key,  required this.title}) : super(key: key);

  final String title;


  @override
  _MyServicess2PageState createState() => _MyServicess2PageState();
}

class _MyServicess2PageState extends State<MyServicess2Page>with WidgetsBindingObserver {
      ...
      /*    clipBehavior: Clip.antiAliasWithSaveLayer,
        ...
        //  SizedBox(height: 100,),
          ...
          onTap:() async {
            ...
            await appState.getServicessW(id ,icontitle);
