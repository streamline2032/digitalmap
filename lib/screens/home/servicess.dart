...
import 'package:store/screens/home/servicess1.dart';
import 'package:store/screens/home/servicess2.dart';
...
class MyServicessPage extends StatefulWidget {
  MyServicessPage({ Key? key,  required this.title}) : super(key: key);

  final String title;


  @override
  _MyServicessPageState createState() => _MyServicessPageState();
}

class _MyServicessPageState extends State<MyServicessPage>with WidgetsBindingObserver {
     ...
     //   margin: EdgeInsets.only(
      ...
      /*    clipBehavior: Clip.antiAliasWithSaveLayer,
        ...
        //  SizedBox(height: 100,),
          ...
          onTap:() async {
            if(id == 0) {
              changeScreen(context, MyServicess1Page(title: 'Servicess1',));
            }else if (id == 1){
              changeScreen(context, MyServicess2Page(title: 'Servicess2',));
            }
            ...
            */
            ...
            appBar: AppBar(
             ...
             // backgroundColor: ColorsConsts.a2,
              ...
              //Center(child:
              Text("الخدمات", style: TextStyle( fontFamily: 'ElMessiri' ,// fontWeight: FontWeight.bold
    ),),),
            //),
            body:
