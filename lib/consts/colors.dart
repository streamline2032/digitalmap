...
class ColorsConsts {
  ...
  static Color a1 = Color(0xFF3E54D3);
  static Color a2 = Color(0xFF4F80E2);
  static Color a3 = Color(0xFFF1F1F1);
  static Color a4 = Color(0xFFA88237);
  ...
  static Color favColor = Color(0xFFF44336); // r ed 500
